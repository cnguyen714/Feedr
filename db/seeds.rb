...
ActiveRecord::Base.transaction do
  ...
  src3.save
  src4 = Source.new(name: "Kotaku", source_url: "https://kotaku.com/", stream_url: "https://kotaku.com/rss")
  src4.save
  ...
  follow3.save
  follow3 = Follow.new(feed_id: feed1.id, source_id: src4.id)
  follow3.save
  follow3 = Follow.new(feed_id: feed3.id, source_id: src5.id)
  follow3.save
